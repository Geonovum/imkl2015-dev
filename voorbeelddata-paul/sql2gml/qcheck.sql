...
select gid,thema,netbeheer from  aanduidingEisVoorzorgsmaatregel                                       l where (select bhcode from utiliteitsnet u where u.thema = l.thema and l.netbeheer = u.authority) is null;
...
select gid,thema,netbeheer from  DT_KabelOfLeiding                                                     l where (select bhcode from utiliteitsnet u where u.thema = l.thema and l.netbeheer = u.authority) is null;
...
select gid,thema,netbeheer from  kabelb                                                                l where (select bhcode from utiliteitsnet u where u.thema = l.thema and l.netbeheer = u.authority) is null;
