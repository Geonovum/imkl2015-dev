...
create table v_aanduidingEisVoorzorgsmaatregel                                          as select 'nl.imkl.'  || u.bhcode || '.' || 'a-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from aanduidingEisVoorzorgsmaatregel                  l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Annotatie_lijn                                                           as select 'nl.imkl.'  || u.bhcode || '.' || 'b-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Annotatie_lijn                                   l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Annotatie                                                                as select 'nl.imkl.'  || u.bhcode || '.' || 'c-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Annotatie                                        l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_BGevaarlijkeInhoud                                                       as select 'nl.imkl.'  || u.bhcode || '.' || 'd-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from BGevaarlijkeInhoud                               l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Containerelement                                                         as select 'nl.imkl.'  || u.bhcode || '.' || 'e-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Containerelement                                 l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Diepte                                                                   as select 'nl.imkl.'  || u.bhcode || '.' || 'f-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Diepte                                           l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_DT_KabelOfLeiding                                                        as select 'nl.imkl.'  || u.bhcode || '.' || 'g-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from DT_KabelOfLeiding                                l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_ExtraDetailInfo                                                          as select 'nl.imkl.'  || u.bhcode || '.' || 'h-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from ExtraDetailInfo                                  l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_ExtraGeometrie                                                           as select 'nl.imkl.'  || u.bhcode || '.' || 'i-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from ExtraGeometrie                                   l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_ExtraTopo                                                                as select 'nl.imkl.'  || u.bhcode || '.' || 'j-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from ExtraTopo                                        l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_KabelEnLeidingContainer                                                  as select 'nl.imkl.'  || u.bhcode || '.' || 'l-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from KabelEnLeidingContainer                          l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Kunstwerk_Containerelement                                               as select 'nl.imkl.'  || u.bhcode || '.' || 'm-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Kunstwerk_Containerelement                       l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Leidingelement                                                           as select 'nl.imkl.'  || u.bhcode || '.' || 'n-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Leidingelement                                   l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_maatvoering_label                                                        as select 'nl.imkl.'  || u.bhcode || '.' || 'p-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from maatvoering_label                                l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_maatvoering_lijn								as select 'nl.imkl.'  || u.bhcode || '.' || 'k-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from maatvoering_lijn                                 l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_maatvoering_pijl                                                         as select 'nl.imkl.'  || u.bhcode || '.' || 'q-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from maatvoering_pijl                                 l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_RioolVV_KabelOfLeiding                                                   as select 'nl.imkl.'  || u.bhcode || '.' || 't-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from RioolVV_KabelOfLeiding                           l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_Water_KabelOfLeiding                                                     as select 'nl.imkl.'  || u.bhcode || '.' || 'v-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from Water_KabelOfLeiding                             l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_elektriciteitskabel                                                      as select 'nl.imkl.'  || u.bhcode || '.' || 'w-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from elektriciteitskabel                              l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_oliegaschemicalien                                                       as select 'nl.imkl.'  || u.bhcode || '.' || 'x-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from oliegaschemicalien                               l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
create table v_kabelbed                                                                 as select 'nl.imkl.'  || u.bhcode || '.' || 'y-' || l.gid as gmlid, l.*,u.unetid,u.gmlid as unetgmlid,u.bhcode from kabelbed                                         l,utiliteitsnet u where u.thema = l.thema and u.authority = l.netbeheer;
