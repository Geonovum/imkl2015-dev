...
//
$query = 'select bhcode,gmlid,unetid,netbeheer,type,status,vertpositi,bzichtbaar,dieptetovm,dieptenap,xinfo,hoogte,detailsch,ST_AsGML(3,geom,5,0,null) as geom from leidingelement ;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
...
while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)) {
    ...
    printcodelistvalue("us-net-common:appurtenanceType","appurtenaceTypeValue",$line["type"]);
...
#
$query = 'select bhcode,gmlid,unetid,netbeheer,status,vertpositi,producttyp,warningt,toelichtin,pressure,pipediam,dieptetovm,dieptenap,xinfo,disttype,ulinkid from oliegaschemicalien ;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
...
// Kabelbed
//
$query = 'select bhcode,ulinkid,gmlid,unetid,type,netbeheer,status,vertpositi,disttype,warningt,ductwidth,bzichtbaar,toelichtin,aantalk,dieptetovm,dieptenap,xinfo,geom from kabelb;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
...
//
$query = 'select bhcode,gmlid,unetid,netbeheer,status,vertpositi,warningt,opvolt,nomvolt,toelichtin,dieptetovm,dieptenap,xinfo,disttype,ulinkid from elektriciteitskabel ;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
...
# Process Riool_vv
#
$query = 'select bhcode,gmlid,unetid,netbeheer,status,vertpositi,disttype,warningt,pipediam,pressure,swatertype,toelichtin,dieptetovm,dieptenap,xinfo,geom,ulinkid from rioolvv_kabelofleiding;';
...
#
$query = 'select bhcode,gmlid,unetid,netbeheer,eisvoorzm,geofict,geom from aanduidingeisvoorzorgsmaatregel;';
...
# Process diepte
#
$query = 'select bhcode,gmlid,unetid,netbeheer,dtovmveld,dtovnap,nauwk from diepte;';
...
# Extra Geometrie
#
$query = 'select bhcode,gmlid,unetid,netbeheer,type,ST_AsGML(3,geom,5,0,null) as geom from extrageometrie;';
...
#
$query = 'select
bhcode,gmlid,unetid,netbeheer,type,typeobject,ST_AsGML(3,geom,5,0,null) as geom from extratopo;';
...
$query = 'select bhcode,gmlid,unetid,netbeheer,label,beschrijvi,ST_AsGML(3,geom,5,0,null) as geom from annotatie;';
...
# Annotatie lijn
#
$query = 'select bhcode,gmlid,unetid,thema,type,netbeheer,ST_AsGML(3,geom,5,0,null) as geom from annotatie_lijn;';
...
# Maatvoering
#
$query = 'select bhcode,gmlid,unetid,netbeheer,type,ST_AsGML(3,geom,5,0,null) as geom from maatvoering;';
...
# Maatvoering_pijl
#
$query = 'select bhcode,gmlid,rotatie,unetid,netbeheer,type,ST_AsGML(3,geom,5,0,null) as geom from maatvoering_pijl;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
...
# Maatvoering_label
#
$query = 'select bhcode,gmlid,unetid,netbeheer,toelichtin,label,ST_AsGML(3,geom,5,0,null) as geom from maatvoering_label;';
$result = pg_query($query) or die('Query failed: ' . pg_last_error());
